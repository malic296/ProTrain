...
$sql = "SELECT firstname from users where ID_users = $DBuserID;";
$result = $connection->query($sql);
$uname = $result->fetch_assoc();
$firstname = $uname["firstname"];

$sql = "SELECT lastname from users where ID_users = $DBuserID;";
$result = $connection->query($sql);
$uname = $result->fetch_assoc();
...
<div class="profile"><i class= "fa-solid fa-circle-user profilePic"></i>
    ...
    <div class="password"><span class = "prof1">Firstname : </span><span class = "prof2"><?php echo " ".$firstname; ?></span></div>
    <div class="password"><span class = "prof1">Lastname : </span><span class = "prof2"><?php echo " ".$lastname; ?></span></div>
